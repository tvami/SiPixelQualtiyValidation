...
#Layer 1
#BpI
#BPix_BpI_SEC5_LYR1_LDR4F_MOD2
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(303087640)
        ), 

#BPix_BpI_SEC5_LYR1_LDR4F_MOD3
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(303087644)
        ), 

#BPix_BpI_SEC5_LYR1_LDR4F_MOD4 
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(303087648)
        ),
#BPix_BpI_SEC5_LYR2_LDR8F_MOD1	
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304201748)
        ),
        
#BPix_BpI_SEC5_LYR2_LDR8F_MOD2
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304201752)
        ), 

#BPix_BpI_SEC5_LYR2_LDR8F_MOD3
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304201756)
        ),
#BPix_BpI_SEC5_LYR2_LDR8F_MOD4
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304201760)
        ), 
#BPix_BpI_SEC5_LYR2_LDR9F_MOD1
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304197652)
        ), 
 
#BPix_BpI_SEC5_LYR2_LDR9F_MOD2
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304197656)
        ), 
 
#BPix_BpI_SEC5_LYR2_LDR9F_MOD3
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304197660)
        ), 
 
#BPix_BpI_SEC5_LYR2_LDR9F_MOD4
        cms.PSet(
            errortype = cms.string('whole'),
            detid = cms.uint32(304197664)
        ), 
#BpI_SEC1_LYR1_LDR1_MOD4
        cms.PSet(
            errortype = cms.string('tbmB'),
            detid = cms.uint32(303050784)
        ), 
...
#BPix_BpO_SEC2_LYR1_LDR2F_MOD3
        cms.PSet(
            errortype = cms.string('tbmA'),
            detid = cms.uint32(303058972)
        ), 
#Layer 2
...
#New from May 2
#BPix_BpI_SEC1_LYR1_LDR1H_MOD4 (303050784)
        cms.PSet(
            errortype = cms.string('tbmB'),
            detid = cms.uint32(303050784)
        ), 
