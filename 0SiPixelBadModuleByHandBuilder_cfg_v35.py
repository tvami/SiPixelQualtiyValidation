...
process.PoolDBOutputService = cms.Service("PoolDBOutputService",
    ...
    connect = cms.string('sqlite_file:SiPixelQuality_v35.db'),
    toPut = cms.VPSet(cms.PSet(
        record = cms.string('SiPixelQualityFromDbRcd'),
        tag = cms.string('SiPixelQuality_v35')
    ))
)

process.prod = cms.EDAnalyzer("SiPixelBadModuleByHandBuilder",
    BadModuleList = cms.untracked.VPSet(
# bad for SiPixelQuality_v35   
#BPix_BpO_SEC2_LYR2_LDR3F_MOD2, TBM-B, rocs 0-7
    cms.PSet(
